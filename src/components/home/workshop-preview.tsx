          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-[1fr_auto]">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-5 font-display text-3xl font-medium leading-tight text-brand-strong sm:text-4xl">
                Thoughtful sessions beyond the regular practice.
              </h2>
              <p className="mt-4 text-lg leading-8 text-muted">
                Workshops are part of the Prabha Yogashala offering. Dates, topics, and formats will be published only after they are confirmed.
              </p>
            </div>
